            ...
            <div class="col-lg-4 col-md-12">
                <div class="teacher-details-desc">
                    <div class="teacher-desc-image">
                        <img src="<?php echo base_url('').'uploads/director/'.$director['director_message_image'];?>" alt="image">
                    </div>
                </div>
            </div>
            <div class="col-lg-8 col-md-12">
                <div class="teacher-details-information"><?php echo $director['director_message'];?>
                </div>
            </div>
        </div>
    </div>
